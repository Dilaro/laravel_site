                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <form method="post" name="123" enctype="multipart/form-data"
                                              action="{{ route('companies.addData', 'companyid') }}">
                                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <div class="form-group">
                                            <label for="t-text" class="sr-only">Text</label>
                                            <input id="t-text" name="text" placeholder="Какой-то текст..."
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <div class="form-group">
                                            <label for="t-text" class="sr-only">Text</label>
                                            <input id="t-text" name="pie_chart" placeholder="Какой-то текст..."
                                                   class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @foreach($data as $el)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('companyiddel', $el->id)}}">
                                    <button class="mt-4 mb-4 btn btn-primary">
