...
<head>
    ...
    <meta name="description"
          content="Более 45 лет занимаемся специальным сектором сельского хозяйства, разведением индейки, распространением инкубационных яиц индейки и суточных индюшат.">
    ...
    @vite(['resources/css/bootstrap.min.css', 'resources/css/plugins.css', 'resources/css/style.css', 'resources/css/green.css',
           'resources/js/app.js', 'resources/js/jquery.min.js', 'resources/js/bootstrap.js',
           'resources/js/plugins.js', 'resources/js/jquery.themepunch.tools.min.js', 'resources/js/scripts.js',
            ...
            <div class="navbar-header">
                <div class="basic-wrapper">
                    ...
                    <div class="navbar-brand"><a href="index.html">
                            <img src="#" srcset="style/images/logo.png 1x, style/images/logo@2x.png 2x"
                                 class="logo-light" alt=""/><img src="#" srcset="style/images/logo-dark.png 1x, style/images/logo-dark@2x.png 2x" class="logo-dark" alt=""/></a>
                    </div>
                    <!-- /.navbar-brand -->
                </div>
                <!-- /.basic-wrapper -->
...
<div class="tp-fullscreen-container revolution">
    <div class="tp-fullscreen">
        <ul>
            <li data-transition="fade"><img src="{{ Vite::asset('resources/style/images/art/slider-bg1.jpg') }}"
                                            alt="PHOTO1" data-bgposition="center top" data-bgfit="cover"
            ...
            <li data-transition="fade"><img src="{{ Vite::asset('resources/style/images/art/slider-bg1.jpg') }}" alt=""
        ...
        <div class="row services">
            <div class="col-sm-4">
                <div class="service text-center">
                    <div class="icon"><img src="{{ Vite::asset('resources/style/images/icons/lulu-web-browser.png') }}"
                                           alt=""/></div>
            ...
            <div id="grid-container" class="cbp">
                ...
                <div class="cbp-item web logo">
                    <a href="ajax/project2.html" class="cbp-caption cbp-singlePageInline">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ Vite::asset('resources/style/images/art/p2.jpg') }}" alt=""/></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item print motion">
                    <a href="ajax/project3.html" class="cbp-caption cbp-singlePageInline">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ Vite::asset('resources/style/images/art/p3.jpg') }}" alt=""/></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item web print">
                    <a href="ajax/project4.html" class="cbp-caption cbp-singlePageInline">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ Vite::asset('resources/style/images/art/p4.jpg') }}" alt=""/></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item motion logo"><a href="ajax/project5.html"
                        ...
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ Vite::asset('resources/style/images/art/p5.jpg') }}" alt=""/></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <div class="cbp-item print motion"><a href="ajax/project6.html"
                                                      class="cbp-caption cbp-singlePageInline">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ Vite::asset('resources/style/images/art/p6.jpg') }}" alt=""/></div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-md-5">
                                <figure><a href="#">
                                        ...
                                        <img src="{{ Vite::asset('resources/style/images/art/tb1.jpg') }}" alt=""/></a>
                                </figure>
                            </div>
                            <!-- /column -->
                            <div class="col-sm-9 col-md-7">
                                ...
                                <div class="meta"><span class="date"><a href="#"
                                        ...
                                        class="comments"><a href="#" class="link-effect"><i class="icon-chat-1"></i> 8</a></span>
                                </div>
                                <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Vivamus sagittis
...
<div class="white-wrapper">
    <div class="col-image">
        <div class="bg-wrapper col-md-6">
            <div class="bg-holder"
                 style="background-image: url({{ Vite::asset('resources/style/images/art/about.jpg') }});"></div>
        </div>
        <!--/.bg-wrapper -->
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-md-offset-7 inner-col">
                    ...
                    <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean
                        eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Donec ullamcorper
                        nulla non metus auctor fringilla. Etiam porta sem malesuada magna mollis euismod.</p>
    ...
    <div class="container inner">
        ...
        <div class="thin3">
            ...
            <p class="text-center">Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.
                ...
                Pellentesque ornare sem lacinia quam venenatis vestibulum. Nullam id dolor id nibh. Fusce dapibus,
    ...
    <div class="container inner">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="tagcloud"><a href="#" style="font-size: 9pt;">blogroll</a> <a href="#" style="font-size: 19pt;">daily</a>
                    <a href="#" style="font-size: 9pt;">dialog</a> <a href="#" style="font-size: 9pt;">gallery</a>
                    <a href="#" style="font-size: 10pt;">journal</a> <a href="#" style="font-size: 9pt;">link</a> <a
                        href="#" style="font-size: 12pt;">motion</a> <a href="#" style="font-size: 9pt;">music</a>
                    <a href="#" style="font-size: 20pt;">photo</a> <a href="#" style="font-size: 13pt;">professional</a> <a
                        href="#" style="font-size: 16pt;">quotation</a> <a href="#" style="font-size: 9pt;">show</a>
